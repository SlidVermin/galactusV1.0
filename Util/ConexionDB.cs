...
{
    public static string cadenaConexionDefault = "Data Source=181.57.176.142;Initial Catalog=DEV_LAB;persist Security Info=True;User ID = galactus_main;Password=galactus_main*;MultipleActiveResultSets=True";
